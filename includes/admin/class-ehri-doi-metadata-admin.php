...
class EHRI_DOI_Metadata_Admin {
	...
	public function testing_section_callback() {
		echo '<p>Settings for testing the plugin with sandbox DOIs.</p>';
	}
	...
	public function resolver_url_prefix_field_callback() {
		...
		echo '<p class="description">The base URL for resolving DOIs</p>';
	}
	...
	public function client_id_field_callback() {
		...
		echo '<p class="description">The client ID for the DOI service</p>';
	}
	...
	public function client_secret_field_callback() {
		...
		echo '<p class="description">The secret key for the DOI service</p>';
	}
	...
	public function fake_citation_doi_field_callback() {
		...
		echo '<p class="description">A placeholder (real) DOI for testing the citation widget
			when using placeholder DOIs that don\'t resolve on https://doi.org/</p>';
	}
